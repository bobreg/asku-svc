#ifndef _UPS_SNMP_PWW_STRUCT_H_
#define _UPS_SNMP_PWW_STRUCT_H_

#include <QDateTime>

#define UPS_SNMP_PWW_DEFAULT	0
#define UPS_SNMP_PWW_93E	1


// UpsPwwState structure
typedef struct tagUpsPwwState
{
	struct UpsPwwState
	{
		union PwwStateReg
...
//			RegState._Data = 0;
	...
	tagUpsPwwState() : Updated()
	{
	}
} UpsPwwState;


#endif // _UPS_SNMP_PWW_STRUCT_H_
