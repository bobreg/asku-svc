...
// ------------------------------------------------------------------
void UPS_SNMP_SERVICE::updateState()
{
	updateUpsState(m_device);
	updateCommonState();
...
// ------------------------------------------------------------------
void UPS_SNMP_SERVICE::updateCommonState()
{
//	bUpsState["ObSost"] = bUpsState["connected"];
}

// ------------------------------------------------------------------
void UPS_SNMP_SERVICE::updateUpsState(SNMP_DEVICE * device)
{
	Q_UNUSED(device);
